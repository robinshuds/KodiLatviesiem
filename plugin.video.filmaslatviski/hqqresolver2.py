    ...
    def resolve(self, vid):
        ...
        if data:
            ...
            if jsonIp and at:
                ...
                # https://hqq.watch/sec/player/embed_player_8799483283660046.php?iss=MTY5LjUwLjYyLjkz&vid=238235261230261237231231239230227243194271217261258&at=4392e4f3448664c399927c26c6e5c5af&autoplayed=yes&referer=on&http_referer=aHR0cDovL21vdmllcGxhY2UubHYvbG9hZC9waWVkeml2b2p1bXUvdHVtc2Fpc190b3JuaXNfdGhlX2RhcmtfdG93ZXIvNy0xLTAtMzkzNQ==&pass=&embed_from=&need_captcha=0&hash_from=&secured=0
